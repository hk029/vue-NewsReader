<template>
    <div class="news-detail">
        ...
        <tool-bar :top="toolTop" :left="toolLeft" v-show="showTool" @deleteWord='deleteWord' @addWord='addWord' @searchWord='searchWord'></tool-bar>
        <div class="side-bar">
            <ul>
                <li @click="toTop">
        ...
        <word-book v-show="showDict" @hideBook="showDict = false"></word-book>
    </div>
</template>
