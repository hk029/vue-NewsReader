    ...
    <div class="news-detail">
        ...
        <div class="article-info">
            <span class="author-info">
                <img src="../assets/cnn.jpg" alt="">
                <span class="author">CNN</span>
            </span>
            <span class="date">2017-06-02</span>
        </div>
        <div class="player-wrap">
            <mini-player :url="myurl"></mini-player>
        </div>
        <div id="content" class="content" @touchstart="touchStart" @touchend="touchEnd" v-html="newcontent">
